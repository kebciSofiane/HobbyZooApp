...
public class NewActivity extends AppCompatActivity {
    ...
    private void setAnimals() {
        posAnimals = 0;
        animals = new ArrayList<>(Arrays.asList("sheep", "cat", "chick", "giraffe", "koala", "lion", "rabbit", "tiger", "bear","beaver","chicken","cow","deer","dog","fox","monkey","panda","pig","raccoon","squirrel"));
    }
